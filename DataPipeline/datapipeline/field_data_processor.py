...
class FieldDataProcessor:
    ...
    def rename_columns(self):
        ...
        # Trim column headers of trailing whitespace
        self.df.columns = self.df.columns.str.strip()
        
    def apply_corrections(self, column_name='Crop_type', abs_column='Elevation'):
        # Trim values in the Crop_type column
        self.df[column_name] = self.df[column_name].str.strip()
        # Ensure the values in abs_column are non-negative
    ...
    def weather_station_mapping(self):
        ...
        # Log information
        #self.logger.info("Weather station mapping completed.")
